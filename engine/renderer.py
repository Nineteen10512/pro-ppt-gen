...
class Renderer:
    ...
    def __init__(self, tokens: dict, lang: str = "cn"):
        ...
        # v1.5.3: shape name registry and slide animation specs
    ...
    _TRANSITION_MAP = {
        ...
        # v1.5.3: directional aliases commonly referenced by templates/animations
    ...
    def apply_transition(self, slide, transition_type: str):
        ...
        以及 v1.5.3 新增的 cube/reveal/zoom/ferris/gallery/conveyor 扩展切换。"""
        ...
        try:
            ...
            if kind == "none" or kind == "":
                return
            # Try extended transitions first (v1.5.3)
            try:
