"""PRO-PPTX/DOCX v1.6.3 shared modules - color palette, theme registry, SVG engine, QA utils, citation formatter, template scanner and registry.
...
- template_registry.py : v1.6.3 新增 — PPTTemplate / DOCXTemplate / TemplateInfo dataclass
- template_scanner.py  : v1.6.3 新增 — 本地 WPS 模板扫描 + theme 提取 + WCAG 对比度校验
